...
def main(b):
    ...
    # noinspection PyTypeChecker
    eaSimple(pop, toolbox=toolbox, cxpb=0.8, mutpb=0.3, ngen=num_of_generations, stats=stats, halloffame=hof,
             verbose=True)
...
if __name__ == '__main__':
    ...
    #     main(b)
    # Parallel(n_jobs=-1)(delayed(main)(b) for b in complexities)
    print()
    print()
